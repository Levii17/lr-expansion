    ...
    >
      <div className="lr-container">
        <div className="lr-section-head lr-reveal">
          <div>
            <div className="lr-eyebrow lr-mono">03 / Selected work</div>
          ...
          <p className="lr-section-intro">
            Developments made real through clarity of thought, material
            integrity and delivery focus.
          </p>
        </div>
        <div className="lr-projects-grid">
          ...
          <div className="lr-projects-side">
            ...
            >
              <div className="project-building project-building-alt" aria-hidden="true" />
              <ArrowUpRight className="project-arrow" size={22} />
              <div className="project-card-label lr-mono">
            ...
            <div className="lr-project-index">
              ...
              <p>Years of construction and development expertise, applied with intent.</p>
